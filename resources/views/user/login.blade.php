    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            height: 100vh;
            background-image: url("/storage/images/back_ground3.gif");
        ...
        .overlay {
            background: #1C6758;
            background: -webkit-linear-gradient(to right, #90B77D, #1C6758);
            background: linear-gradient(to right, #90B77D, #1C6758);
