        ...
        <div class="text-white bg-dark" style="flex: 1;">
            ...
            <div class="col-12 bg-black main_container p-5" style="height: calc(100vh - 70px); overflow-y: scroll;">
                <div class="col-12 text-right text-white" style="text-align: right;">
                    <button class="btn btn-success px-5" id="btn-add">Thêm người dùng</button>
                    ...
                    <tbody>
                        ...
                        foreach ($users as $user) {
                            if ($user->role != 'admin') {
                                ...
                                <tr>
                                    <td>
                                    <img src='/storage/images/user/$user->avatar' alt='' width='30px' height='30px' class='rounded-circle'>
                                    <span class='ms-2 py-2'>$user->name</span>
                                    </td>
                                    <td>$user->email</td>
